...
| Hosted gates | Workflow semantic lint, Python matrix with headless TUI journey, strict Podman shell validation and real Pi lifecycle/tmux validation on PRs into `main` and `feat/**`, plus pushes to `main` and the feature integration branch |
